...
class SavingsApp(App):
    def build(self):
        ...
        sm.add_widget(FamilySavingScreen(name='five_year_saving'))
        sm.add_widget(FamilySavingScreen(name='profit_bearing'))
        sm.add_widget(FamilySavingScreen(name='pensioner_saving'))
        return sm
